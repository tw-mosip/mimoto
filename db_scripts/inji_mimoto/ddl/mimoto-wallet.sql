...
CREATE TABLE IF NOT EXISTS wallet (
    ...
    user_id VARCHAR(255) NOT NULL,  -- User ID, foreign key referring to the user_metadata table
    wallet_key TEXT NOT NULL,  -- Encrypted wallet key using AES256-GCM with user’s PIN
    public_key TEXT NOT NULL,  -- Public key for the wallet
...
COMMENT ON COLUMN wallet.wallet_key IS 'Wallet Key: Encrypted wallet key using AES256-GCM with the user\'s PIN';
