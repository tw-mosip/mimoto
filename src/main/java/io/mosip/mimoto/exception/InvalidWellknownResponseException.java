...
public class InvalidWellknownResponseException extends BaseCheckedException {
    ...
    protected InvalidWellknownResponseException( Throwable cause) {
        super(PlatformErrorMessages.INVALID_CREDENTIAL_ISSUER_WELLKNOWN_RESPONSE_EXCEPTION.getCode(),PlatformErrorMessages.INVALID_CREDENTIAL_ISSUER_WELLKNOWN_RESPONSE_EXCEPTION.getMessage(),cause);
    }
}
